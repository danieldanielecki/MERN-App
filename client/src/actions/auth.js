...
// Login User action.
// Dispatch more than 1 action type from this function. We're able to do it because of the "thunk" middleware, the crucial point it "(email, password)" parameters then "=>", "(dispatch)" and "=>" again to do so.
