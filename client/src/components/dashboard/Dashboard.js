...
const Dashboard = ({
  ...
  }, [getCurrentProfile]); // The brackets "[]" here makes "useEffect()" to run only once, without brackets "useEffect()" will keep running and it'll be a constant loop. The brackets basically are equivalent to "componentDidMount()" in Class Components. ESLint said that "getCurrentProfile" should be added as dependency between the "[]". Therefore, fix this warning too.
