...
// Pull out these values, so every time we access the property we don't have to do, for example, "props.component", instead simply use this variable directly "component". Same logic applies for "auth" and anything else that is passed in ("...rest"). In addition to that, from "auth" pull out "isAuthenticated" and "loading".
const PrivateRoute = ({
  component: Component,
