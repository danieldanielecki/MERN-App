...
// Pull out these values, so every time we access the property we don't have to do, for example, "props.auth", instead simply "auth". Same logic applies for "logout". In addition to that, from "auth" pull out "isAuthenticated" and "loading".
