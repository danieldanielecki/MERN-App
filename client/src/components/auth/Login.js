...
const Login = ({ login, isAuthenticated }) => {
  ...
  const { email, password } = formData; // Pull out these values from "formData", so every time we access the property we don't have to do "formData.company", instead just "company", etc.
